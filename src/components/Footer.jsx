        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-primary">UPCHAARAK</h3>
                <p className="text-xs text-muted-foreground -mt-1">AI Health Assistant</p>
              </div>
            </div>
            <p className="text-muted-foreground text-sm mb-4 max-w-md">
              Making healthcare accessible through AI-powered assistance. Get instant health guidance, 
              book appointments, and track your health journey with UPCHAARAK.
            </p>
        ...
        <div className="border-t border-border pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-muted-foreground text-sm mb-4 md:mb-0">
              © {currentYear} UPCHAARAK. All rights reserved. Made with ❤️ for better healthcare.
            </div>
